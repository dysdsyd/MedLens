...
class MOB(object):
	...
	def impact_table(self):
		...
		s_imp = s_imp.reset_index()
		#display(s_imp)
		s_imp.to_html('launch/static/media/segment_impact.html')




	def create_summary(self):
		self.master_data = pd.read_csv('launch/04_Results/'+self.ver_string+'/master_data_full.csv', dtype=self.id_type)
